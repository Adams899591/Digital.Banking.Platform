<span>
    ...
    <div x-show="showDeleteModal" x-cloak class="fixed inset-0 bg-gray-600 bg-opacity-75 overflow-y-auto h-full w-full z-50 flex items-center justify-center">
        <div class="relative mx-auto p-6 border w-full max-w-sm shadow-lg rounded-xl bg-white">
            <div class="text-center">
                ...
                <h3 class="text-lg leading-6 font-bold text-bank-navy">Delete Account?</h3>
                <p class="text-sm text-gray-500 mt-2">Are you sure you want to delete this account? This action cannot be undone.</p>
                ...
                <div class="mt-6 flex justify-center gap-3">
                    ...
                    <button wire:click="deleteAccount" class="bg-red-600 text-white px-4 py-2 rounded-lg font-medium hover:bg-red-700 transition-colors flex items-center justify-center min-w-[100px]">
                        <span wire:loading.remove wire:target="deleteAccount">Confirm</span>
    ...
    <div x-show="showDeleteSuccessModal" 
         x-on:account-deleted.window="showDeleteSuccessModal = true; showDeleteModal = false" 
         x-cloak 
        ...
        <div class="relative mx-auto p-6 border w-full max-w-sm shadow-lg rounded-xl bg-white">
            <div class="text-center">
                ...
                <p class="text-sm text-gray-500 mt-2">The account has been deleted successfully.</p>
