    ...
    <div class="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
        <div class="bg-white py-8 px-4 shadow-md rounded-xl border border-gray-100 sm:px-10">
            ...
            <div class="mt-6 text-center">
                <a href="{{route("adminLogin")}}" class="font-medium text-sm text-bank-gold hover:text-bank-navy transition-colors flex items-center justify-center gap-2" wire:navigate >
